...
<section class="schedule-day">
    <div class="schedule-nav">
        <a class="schedule-prev" href="./?schedule-day-4"></a>
        <div data-day="5">
    ...
    <div class="schedule-session">
        ...
        <p>Avalon | <a href="./?program-schedule-workshops#Workshop_VLIoT">VLIoT</a></p>
        <p>Emerald Bay + Santa Monica | <a href="./?program-schedule-workshops#Workshop_BOSS">BOSS</a></p>
    </div>
    <div class="schedule-session">
...
<?php
define('PageTitle', "Fri, Aug 30 Schedule");
define('PageDescription', "Schedule for Day 5.");
?>