<section class="program-schedule-keynote-speakers">
    ...
    <p class="industry-talk">
        ...
        <strong class="talk-title">Graph Processing: A Panaromic View and Some Open Problems</strong>
        <span class="talk-person"><span class="author">M. Tamer Özsu</span> (University of Waterloo)</span>
    ...
    <p class="industry-talk">
        <img class="talk-photo" src="./img/people/TovaMilo.jpg" />
        <strong class="talk-title">Getting Rid of Data</strong>
        <span class="talk-person"><span class="author">Tova Milo</span> (Tel Aviv University, Israel)</span>
        <span class="talk-abstract">
            <a class="talk-abstract-action"></a>
            <strong>Abstract:</strong>
