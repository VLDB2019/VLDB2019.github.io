<section class="formatting-guidelines">
    ...
    <ul>
        ...
        <li>contain the same author information as in the <a href="https://cmt3.research.microsoft.com/VLDB2019/">CMT</a>. e.g., the order of the authors must be the same in the
