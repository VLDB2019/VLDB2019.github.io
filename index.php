...
<header>
    ...
    <div class="small-header"><figure class="logo"><img src="./img/logo.svg" alt="VLDB 2019 LA CA USA"></figure></div>
    <nav itemscope itemtype="http://schema.org/SiteNavigationElement">
        <figure class="logo"><img src="./img/logo.svg" alt="VLDB 2019 LA CA USA"></figure>
        <div>
            General Information
            <div class="menu">
        ...
        <div>
            ...
            <div class="menu">
                ...
                <hr/>
                <a href="./?demonstrations" itemprop="url"><span itemprop="name">Demonstrations</span></a>
                <a href="./?tutorials" itemprop="url"><span itemprop="name">Tutorials</span></a>
